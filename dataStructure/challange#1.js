...
const game = {
  ...
  const[golki , ...fieldplayertwo] = playerTwo;
  console.log(gk , ...fieldPlayers);
  console.log(golki , ...fieldplayertwo)
  // console.log(golki , fieldplayertwo)
  const allplayer = [...playerOne , ...playerTwo];
 ...
 const playersFinal = ['Thiago', 'Coutinho' , 'Perisic' , ...playerOne];
...
/*6. Write a function ('printGoals') that receives an arbitrary number of player names (NOT an array)
  ...
  team1 > team2 && console.log("team2 is more likely to win the game .. ");